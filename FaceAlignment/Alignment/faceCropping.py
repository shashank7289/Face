...
def readPoints(database):
    ...
    for filePath in os.listdir(databaseLmarks):
        ...
        if filePath.endswith(".txt"):
            ...
            with open(os.path.join(databaseLmarks, filePath)) as file :
...
if __name__ == '__main__' :
    ...
    databaseLmarks = 'D:/Codes/TestData/Averaging/Frontalized_image_FEI_database_OpenCV_Landmarks/'
    databaseImages = 'D:/Codes/TestData/Averaging/Frontalized_image_FEI_database_OpenCV/'
